<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li>
                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Home Sliders</span></a>
                <ul>
                    <li><a class="submenu" href="{{url('/add-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Slider</span></a></li>
                    <li><a class="submenu" href="{{url('/list-sliders')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> List Sliders</span></a></li>
                </ul>   
            </li>
